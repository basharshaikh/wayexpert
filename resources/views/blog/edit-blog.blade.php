            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <input value="{{$blog->title}}" type="text" name="title" id="title" class="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border"
                        />
                    </div>
                    <!-- featured images -->
                    <div>
                        ...
                        @if($blog->featured_image != null)
                            <img class="my-3" width="200" src="{{asset('storage/' . $blog->featured_image)}}" alt="{{$blog->title}}">
                        @endif
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3" class="p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{$blog->description}}</textarea>
                            @error('description')
                    ...
                    <div>
                        ...
                        <input type="text" name="tag" id="tag" class="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md " placeholder="technology, future, news" value="{{$blog->tag}}"
                        />
                        @error('tag')
                        <p class="text-red-500 text-xs m-1">{{$message}}</p>
                        @enderror
